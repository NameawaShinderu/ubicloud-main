...
module Config
  ...
  optional :onprem_ssh_private_key, string, clear: true
  optional :onprem_ssh_private_key_passphrase, string, clear: true
  optional :onprem_ssh_public_key, string
  
  # On-premises networking
  override :onprem_default_ipv6_prefix, "fd00:ubicloud:onprem::/48", string
  optional :onprem_ipv6_prefix, string
  
  # On-premises identification
  override :onprem_data_center_name, "onprem-dc-01", string
  optional :onprem_server_identifiers, string
  
  # On-premises operational settings
  override :onprem_health_check_interval, 300, int  # 5 minutes
  override :onprem_enable_ipmi, false, bool
  optional :onprem_ipmi_host, string
  optional :onprem_ipmi_user, string, clear: true
  optional :onprem_ipmi_password, string, clear: true
end
